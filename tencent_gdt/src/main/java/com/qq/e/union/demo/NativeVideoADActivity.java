 ...
 */
public class NativeVideoADActivity extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter = new PosIdArrayAdapter(this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.native_video_ad));
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        posIdEdt.setText(getResources().getStringArray(R.array.native_video_ad_value)[position]);
    }
