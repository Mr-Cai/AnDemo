...
public class ContentADActivity extends Activity implements ContentAD.ContentADListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((EditText) findViewById(R.id.posId)).setText(PositionId.CONTENT_AD_POS_ID);
        loadAd = findViewById(R.id.loadContentAD);
        showAd = findViewById(R.id.showContentAD);
    ...
    private String getPosID() {
        ...
        return TextUtils.isEmpty(posId) ? PositionId.CONTENT_AD_POS_ID : posId;
    }
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null || convertView.getTag() == null) {
                ...
                if (contentAdData.getType() == ContentAdType.AD) {
                    ...
                    viewHolder.mediaView = convertView.findViewById(R.id.gdt_media_view);
                    viewHolder.imgLogo = convertView.findViewById(R.id.img_logo);
                    viewHolder.imgPoster = convertView.findViewById(R.id.img_poster);
                    viewHolder.textName = convertView.findViewById(R.id.text_title);
                    viewHolder.textDesc = convertView.findViewById(R.id.text_desc);
                    viewHolder.btnDownload = convertView.findViewById(R.id.btn_download);
                    viewHolder.play = convertView.findViewById(R.id.btn_play);
                    ...
                    viewHolder.imgPoster = convertView.findViewById(R.id.img);
                    viewHolder.textName = convertView.findViewById(R.id.title);
                    viewHolder.textDesc = convertView.findViewById(R.id.from);
                    viewHolder.btnDownload = convertView.findViewById(R.id.clickme);
                }
