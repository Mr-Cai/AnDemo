                ...
                if (cursor != null)
                    if (cursor.moveToFirst()) {
                        ...
                        do {
                            ...
                            val name =
                                cursor.getString(cursor.getColumnIndex(Config.COLUMN_PERSON_NAME))
                            val email =
                                cursor.getString(cursor.getColumnIndex(Config.COLUMN_PERSON_EMAIL))
                            val phone =
                                cursor.getString(cursor.getColumnIndex(Config.COLUMN_PERSON_PHONE))
                            val occupation =
                                cursor.getString(cursor.getColumnIndex(Config.COLUMN_PERSON_OCCUPATION))
