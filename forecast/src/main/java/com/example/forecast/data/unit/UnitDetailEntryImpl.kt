...
data class UnitDetailEntryImpl(
    ...
    @ColumnInfo(name = "condCodeDay") override val condCodeDay: String, // 白天天气状况代码(305: 小雨)
    @ColumnInfo(name = "condCodeNight") override val condCodeNight: String, // 夜间天气状况代码
    ...
    @ColumnInfo(name = "windSpeed") override val windSpeed: String // 风速(4)
) : UnitDetailEntry