...
object GlobalUtil {
    ...
    val appPackage: String
        get() = GifFun.context!!.packageName
     ...
     */
    val appName: String
        get() = GifFun.context!!.resources.getString(GifFun.context!!.applicationInfo.labelRes)
    ...
    val appVersionName: String
        get() = GifFun.context!!.packageManager.getPackageInfo(appPackage, 0).versionName
    ...
    val appVersionCode: Int
        get() = GifFun.context!!.packageManager.getPackageInfo(appPackage, 0).versionCode
    ...
    fun getString(resId: Int): String {
        return GifFun.context!!.resources.getString(resId)
    }
    ...
    fun getResourceId(name: String, type: String): Int {
        return GifFun.context!!.resources.getIdentifier(name, type, appPackage)
    }
    ...
    fun getApplicationMetaData(key: String): String? {
        ...
        try {
            applicationInfo = GifFun.context!!.packageManager.getApplicationInfo(
                appPackage,
    ...
    fun isInstalled(packageName: String): Boolean {
        val packageInfo: PackageInfo? = try {
            GifFun.context!!.packageManager.getPackageInfo(packageName, 0)
        } catch (e: PackageManager.NameNotFoundException) {
            null
        }
    ...
    fun getAppIcon(): Drawable {
        val packageManager = GifFun.context!!.packageManager
     ...
     * 判断当前版本是否是开源版本。
     */
    fun isOpenSource() = GifFun.packageName == "com.quxianggif.opensource"
