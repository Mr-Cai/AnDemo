...
class FabTransform private constructor(@param:ColorInt private val color: Int, @param:DrawableRes private val icon: Int) :
    Transition() {
    ...
    override fun createAnimator(
        ...
        if (fromFab) {
            ...
            circularReveal.interpolator =
                AnimUtils.getFastOutLinearInInterpolator(sceneRoot.context)
        } else {
            circularReveal = ViewAnimationUtils.createCircularReveal(
                view,
                view.width / 2,
            ...
            circularReveal.interpolator =
                AnimUtils.getLinearOutSlowInInterpolator(sceneRoot.context)
