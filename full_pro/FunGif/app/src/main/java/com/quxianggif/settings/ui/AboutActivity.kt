...
open class AboutActivity : BaseActivity() {
    ...
    override fun setupViews() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            openSourceListTextView.text = Html.fromHtml(
                "<u>" + GlobalUtil.getString(R.string.open_source_project_list) + "</u>",
                0
            )
        } else {
            openSourceListTextView.text =
                Html.fromHtml("<u>" + GlobalUtil.getString(R.string.open_source_project_list) + "</u>")
        }
    ...
    companion object {
        ...
        private val ACTION_VIEW_ABOUT = "${GifFun.packageName}.ACTION_VIEW_ABOUT"
