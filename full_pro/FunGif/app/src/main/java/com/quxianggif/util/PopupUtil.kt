...
object PopupUtil {
    ...
    fun showUserFeedExpandMenu(
        activity: Activity,
        expandMenuItems: List<String>,
        anchor: View
    ): Pair<PopupWindow, ListView> {
        ...
        expandMenuList.adapter =
            ArrayAdapter(activity, R.layout.user_feed_more_item, expandMenuItems)
